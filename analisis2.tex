...
\[\begin{minipage}[b]{1\textwidth}
    \includegraphics[width=\linewidth]{assets/curva_nivel.png}
\end{minipage}\]
\subsection*{Trazas}
...
\[\begin{minipage}[b]{1\textwidth}
    \includegraphics[width=\linewidth]{assets/traza.png}
\end{minipage}\]
\[\begin{minipage}[b]{0.8\textwidth}
    \includegraphics[width=\linewidth]{assets/curva_traza.png}
\end{minipage}\]
...
\end{itemize}
\subsection*{Error del Polinomio de Taylor (Forma de Lagrange del Resto en $\float^{2}$)}
La fórmula es exactamente igual a la de 1 variable pero lo que cambia es que ya no tenemos un $x_{0}$ sino que ahora tenemos un $c_{1}$ y un $c_{2}$ donde: 
\begin{itemize}
    \item $c_{1}$ está entre $x$ y $x_{0}$
    \item $c_{2}$ está entre $y$ y $y_{0}$
\end{itemize}
Entonces, definimos: 
\[E_{n}(x, y) = R_{n}(x,y) = f(x,y) - P_{n}(x,y) = \frac{f^{n+1}(c_{1}, c_{2})(x-x_{0})^{n+1}(y-y_{0})^{n+1}}{(n+1)!}\]
Véase \hyperref[subsec:error_polinomio_taylor_2]{\textbf{\underline{anexo}}} para un ejemplo 
...
\[\begin{minipage}[b]{0.6\textwidth}
    \includegraphics[width=\linewidth]{assets/maximo_minimo_local.png}
\end{minipage}\]
...
\[\begin{minipage}[b]{0.6\textwidth}
    \includegraphics[width=\linewidth]{assets/maximo_absoluto_minimo.png}
\end{minipage}\]
...
\section*{Frontera o Borde de un Conjunto D}
Llamamos frontera o borde de un conjunto D a $\partial D = \{x \in \float^{n}, \forall r > 0, Br(x) \cap D \neq \emptyset, Br(x) \cap D^{c} \neq \emptyset\}$ \\
...
\[\begin{minipage}[b]{0.6\textwidth}
    \includegraphics[width=\linewidth]{assets/conjunto_d.png}
\end{minipage}\]
...
\[\begin{minipage}[b]{0.5\textwidth}
    \includegraphics[width=\linewidth]{assets/ejemplo_conjunto_cerrado_1.png}
\end{minipage}\]
\[\begin{minipage}[b]{0.8\textwidth}
    \includegraphics[width=\linewidth]{assets/borde.jpg}
\end{minipage}\]
...
\[\begin{minipage}[b]{0.7\textwidth}
    \includegraphics[width=\linewidth]{assets/conjunto_d_acotado.png}
\end{minipage}\]
...
\[\begin{minipage}[b]{1\textwidth}
    \includegraphics[width=\linewidth]{assets/maximos_minimos.png}
\end{minipage}\]
\begin{itemize}
...
\end{itemize}
\[\begin{minipage}[b]{0.6\textwidth}
    \includegraphics[width=\linewidth]{assets/maximo_minimo_restringido_absoluto.png}
\end{minipage}\]
...
\[\begin{minipage}[b]{0.8\textwidth}
    \includegraphics[width=\linewidth]{assets/integrales_1.png}
\end{minipage}\]
...
\[\begin{minipage}[b]{0.8\textwidth}
    \includegraphics[width=\linewidth]{assets/integrales_2.png}
\end{minipage}\]
...
\[\begin{minipage}[b]{0.8\textwidth}
    \includegraphics[width=\linewidth]{assets/integrales_iteradas.png}
\end{minipage}\]
...
\begin{itemize}
    ...
    \[\begin{minipage}[b]{0.8\textwidth}
    \includegraphics[width=\linewidth]{assets/integrales_inmediatas.png}
\end{minipage}\]
    ...
    \[\begin{minipage}[b]{0.6\textwidth}
    \includegraphics[width=\linewidth]{assets/fracciones_simples.png}
\end{minipage}\]
\end{itemize}
...
\[\begin{minipage}[b]{0.9\textwidth}
    \includegraphics[width=\linewidth]{assets/regiones_elementales.png}
\end{minipage}\]
...
\begin{itemize}
    \item Muchas veces hay regiones que pueden escribirse de un Tipo y no de otro. Cuando la región puede escribirse de las dos formas, se llama Región de Tipo III. Ah, y otra cosa, que pueda escribirse de las dos formas no significa que al integrar la dificultad sea la misma. 
...
\[\begin{minipage}[b]{0.5\textwidth}
    \includegraphics[width=\linewidth]{assets/regiones_tipo_1.png}
\end{minipage}\]
...
\[\begin{minipage}[b]{0.3\textwidth}
    \includegraphics[width=\linewidth]{assets/tipo_1_piramide.png}
\end{minipage}\]
Buscamos qué ecuaciones representan al triangulo que solo dependen de x e y: 
\[\begin{minipage}[b]{0.8\textwidth}
    \includegraphics[width=\linewidth]{assets/region_tipo_1_dib.png}
\end{minipage}\]
Por último, ya con x, y definidos, ahora para calcular el volúmen ponemos el techo (el plano).
\[\begin{minipage}[b]{0.6\textwidth}
    \includegraphics[width=\linewidth]{assets/integral_tipo_1_r3.png}
\end{minipage}\]
...
\[\begin{minipage}[b]{0.8\textwidth}
    \includegraphics[width=\linewidth]{assets/tipo_2.png}
\end{minipage}\]
\subsubsection*{Tipo III}
Parecido a una región tipo I y tipo II. Ahora las variables libres son $(y, z)$
\[\begin{minipage}[b]{0.6\textwidth}
    \includegraphics[width=\linewidth]{assets/tipo_3.png}
\end{minipage}\]
...
\[\begin{minipage}[b]{0.9\textwidth}
    \includegraphics[width=\linewidth]{assets/bases_tipos.png}
\end{minipage}\]
...
\[\begin{minipage}[b]{0.9\textwidth}
    \includegraphics[width=\linewidth]{assets/tipo_3_y_z.png}
\end{minipage}\]
Por último, planteamos la integral
\[\begin{minipage}[b]{0.9\textwidth}
    \includegraphics[width=\linewidth]{assets/tipo_3_y_z_int.png}
\end{minipage}\]
...
\[\begin{minipage}[b]{0.9\textwidth}
    \includegraphics[width=\linewidth]{assets/teo_cambio_variable_r3.png}
\end{minipage}\]
...
\[\begin{minipage}[b]{1\textwidth}
    \includegraphics[width=\linewidth]{assets/def_coordenadas_cilindricas.png}
\end{minipage}\]
\[\begin{minipage}[b]{1\textwidth}
    \includegraphics[width=\linewidth]{assets/cambio_variable_r3.png}
\end{minipage}\]
Entonces \\
$\phi$: 
$\begin{cases}
...
\[\begin{minipage}[b]{0.6\textwidth}
    \includegraphics[width=\linewidth]{assets/coordenadas_cilindricas.png}
\end{minipage}\]
...
\[\begin{minipage}[b]{0.8\textwidth}
    \includegraphics[width=\linewidth]{assets/coordenadas_cilindricas_2.png}
\end{minipage}\]
...
\[\begin{minipage}[b]{0.8\textwidth}
    \includegraphics[width=\linewidth]{assets/coordenadas_cilindricas_3.png}
\end{minipage}\]
Véase \hyperref[subsec:coordenadas_cilindricas]{\textbf{anexo}} para ejercicios de Coordenadas Cilíndricas
...
\end{itemize}
\[\begin{minipage}[b]{1\textwidth}
    \includegraphics[width=\linewidth]{assets/coordenadas_esfericas_1.png}
\end{minipage}\]
\[\begin{minipage}[b]{1\textwidth}
    \includegraphics[width=\linewidth]{assets/coordenadas_esfericas_2.png}
\end{minipage}\]
\subsubsection*{Jacobiano}
...
\[\begin{minipage}[b]{1\textwidth}
    \includegraphics[width=\linewidth]{assets/coordenadas_esfericas_3.png}
\end{minipage}\]
...
\[\begin{minipage}[b]{1\textwidth}
    \includegraphics[width=\linewidth]{assets/coordenadas_esfericas_4.png}
\end{minipage}\]
\section*{Anexo}
\subsection*{Esferas}
...
\[\begin{minipage}[b]{0.4\textwidth}
    \includegraphics[width=\linewidth]{assets/extremos_absolutos.png}
\end{minipage}\]
...
\[\begin{minipage}[b]{0.6\textwidth}
    \includegraphics[width=\linewidth]{assets/region.png}
\end{minipage}\]
...
\subsection*{Integrales Impropias, Convergencia y Divergencia (idea)}
\begin{itemize}
    \item Ver cuales son los puntos conflictivos.
    \item Ver el denominador 
    \begin{itemize}
        \item Si tenemos exponente sospechar que vamos a usar series p.
        \item Si tenemos una raíces, vamos a tener que usar fracciones simples.
    \end{itemize}
    \item Si en el numerador tenemos muchas cosas como cos, sen, vamos a acotar por algo más grande. Es decir, por el máximo valor que pueden tomar. 
\end{itemize}
Recordar que el criterio que más vamos a usar es el de comparación directa. Es decir, si empezamos con una integral f(x) y vamos acotando por algo mayor y llegamos a un resultado, esta f(x) está obligada a tender a lo mismo. \\
Es realmente importante notar que límites tienen las integrales. Si las integrales tienen infinito podemos muchas veces prescindir de información porque \textbf{no aportan nada}. Mientras que si las integrales no tienen infinito, no podemos usar ese truco. \\
En las Integrales que no tienden a infinito casi siempre tenemos que estar usando límites y analizar por cada lado. 
...
\textbf{Ejercicio 1}: $\int^{2}_{1} \frac{1}{x-2} dx$: Lo primero que hay que notar desde ya es que la integral tiene límites constantes, por lo tanto no podemos usar ninguna propiedad donde acotamos porque indicamos que en el infinito x cosa no aporta. \\
Lo segundo que podemos notar es que en el denominador tenemos una x, y en el numerador un 1. Esto se parece a series p pero de alguna manera tendríamos que sacarnos de encima el -2. \\
Como es una Integral bastante simple, probemos viendo qué pasa cuando hacemos el límite. Es decir, vamos a ver qué pasa cuando nos acercamos al 2 por izquierda. \\
$\lim_{t\to 2^{-}} \int^{t}_{1} \frac{1}{x-2}dx = lim_{t\to 2^{-}} ln\longitud{x-2} \Big |^{t}_{1} = lim_{t\to 2^{-}} ln \longitud{t-2} - ln \longitud{1-2} = lim_{t\to 2^{-}} ln \longitud{1.99-2} = lim_{t\to 2^{-}} ln(0^{+}) = -\infty $ \\
\textbf{Nota}: $ln(0^{+}) = \infty$ \\
\textbf{Ejercicio 2}: $\int^{4}_{1} \frac{1}{x-2} dx$: Este no lo voy a hacer pero si está bueno justificar el por qué. Si nos damos cuenta, el problema está también en x = 2, por lo tanto para poder analizar el caso podemos separar en dos integrales $\int^{2}_{1} \frac{1}{x-2} dx + \int^{4}_{2} \frac{1}{x-2} dx$ y observando la integral de la izquierda, es la que hicimos antes acercándonos a 2 por izquierda y divergía. Por lo tanto, la Integral más grande $\int^{4}_{1} \frac{1}{x-2} dx$ también diverge. Con esto quiero decir que si \textbf{una} de las integrales diverge, las demás también.  \\
\textbf{Ejercicio 2}:$\int^{4}_{1} \frac{1}{(x-2)(x-4)} dx$: Los problemas en esta integral vienen en $x=2$ y en $x=4$. Por lo tanto, lo primero que podemos hacer es hacer fracciones simples. \\
$\frac{A}{x-2} + \frac{B}{x-4} = \frac{1}{(x-2)(x-4)}$ \\
$\frac{A(x-4)+ B(x-2)}{(x-2)(x-4)} = \frac{1}{(x-2)(x-4)}$ \\
$A(x-4) + B(x-2) = \frac{(x-2)(x-4)}{(x-2)(x-4)}$ \\
$A(x-4) + B(x-2) = 1$ \\
A partir de ahora como tenemos que encontrar A y B simplemente los posibles valores a x que puede tomar, en este caso: 
\begin{itemize}
    \item Si $x = 4, 2B = 1 \implies B = \frac{1}{2}$
    \item Si $x = 2, -2A = 1 \implies A = -\frac{1}{2}$
\end{itemize}
Ahora reemplazamos en cada fracción en particular, es decir: $\frac{A}{x-2} + \frac{B}{x-4} \equiv \frac{-\frac{1}{2}}{x-2} + \frac{\frac{1}{2}}{x-4}$ \\
Volvemos a la Integral y nos queda: $\int^{4}_{1} \frac{-\frac{1}{2}}{x-2} + \frac{\frac{1}{2}}{x-4} \equiv \int^{4}_{1} -\frac{1}{2(x-2)} + \frac{1}{2(x-4)} $. Ahora sí podemos separar la integral en dos por propiedades \\
$\int^{4}_{1} -\frac{1}{2(x-2)} + \int^{4}_{1} \frac{1}{2(x-4)}$ \\
Ahora analicemos una por una en los puntos conflictivos. Recordar que con que una diverja, todo diverge. Entonces, tomemos la primera y separemos en dos intervalos. \\
$\int^{2}_{1} -\frac{1}{2(x-2)} + \int^{4}_{2} -\frac{1}{2(x-2)}$ \\
Analicemos por izquierda la primera integral. \\
$-\frac{1}{2} \int^{2}_{1} \frac{1}{(x-2)} dx$ \\
Planteamos el límite: $ \lim_{t\to 2^{-}} -\frac{1}{t} \int^{2}_{1} \frac{1}{(x-2)} dx \stackrel{sustitucion}{=} \lim_{t\to 2^{-}} -\frac{1}{2} ln(\longitud{x-2}) \Big |^{t}_{1} = \lim_{t\to 2^{-}} -\frac{1}{2} (ln(\longitud{t-2}) - ln(\longitud{-1})) = \lim_{t\to 2^{-}} -\frac{1}{2} (ln(0) - 0)$ \\
Como entonces nos quedó $\lim_{t\to 2^{-}} -\frac{1}{2} (ln(0^{+})) = \lim_{t\to 2^{-}} -\frac{1}{2} \infty = \infty \implies diverge $ \\
Luego, toda la integral diverge.  \\
\textbf{Ejercicio 3}: $\int^{1}_{0} \frac{ln(x)}{x}$. Esta Integral tiene un problema en $x=0$ por lo tanto, planteemos el límite y la integral. Sale rápido por sustitución: $\lim_{t\to 0^{+}} \int^{1}_{t} \frac{1}{x} ln(x) dx \stackrel{sust}{=} \lim_{t\to 0^{+}} \frac{ln^{2}(x)}{2} \Big |^{1}_{t} =  \lim_{t\to 0^{+}} 0 - \frac{ln^{2}(t)}{2} = \lim_{t\to 0^{+}} -(-\infty)^{2} = -\infty \implies diverge $ 
\subsection*{Integrales Impropias: Criterio de Comparación Directa}
Criterio de Comparación Directa: Si tengo una función f y g ambas integrables en un intervalo cerrado y $f(x) \le g(x)$ entonces si encuentro una función $g(x)$ mayor a $f(x)$ que converja, entonces f converge. \\ Si $g(x)$ diverge y $f(x) \ge g(x)$, entonces f diverge. \\
\textbf{Ejercicio 1}: $\int^{+\infty}_{1} \frac{x^{2} \longitud{sen(x)}}{(x^{2}+1)x^{5}}$ \\
Vamos a usar el criterio de comparación directa, entonces acotemos para buscar funciones más grandes. \\
$\stackrel{sen}{\le} \frac{x^{2}}{(x^{2}+1) x^{5}}  = \frac{x^{2}}{x^{7} + x^{5}} \stackrel{x^{7} > x^{5}}{\le} \frac{x^{2}}{x^{7}} = \frac{1}{x^{5}} = \int^{+\infty}_{1} \frac{1}{x^{5}} $
Esta función g que encontramos, es decir $\int^{+\infty}_{1}  \frac{1}{x^{5}}$ converge pues $p>1$. Luego, como $f(x) \le g(x)$ entonces por el criterio de comparación directa $f(x)$ también converge. \\
¿A qué valor converge?: $\int^{\infty}_{1} \frac{1}{x^{5}} dx = \int^{\infty}_{1} x^{-5} dx = \frac{x^{-4}}{-4} = -\frac{x^{-4}}{4} = \frac{1}{\frac{x^{4}}{4}} = \frac{1}{4x^{4}} \Big |^{\infty}_{1} = (0 + \frac{1}{4}) = \frac{1}{4} $
...
Primero arrancamos poniendo los corchetes (importante y obligatorio): $\int^{1}_{0}[\int^{1}_{-1}(x^{2}+y^{2} dx)] dy = \int^{1}_{0}(\frac{x^{3}}{3}y+y^{2}x) \Big |^{1}_{-1} dy \stackrel{barrow}{=} \int^{1}_{0}[(\frac{1}{3}+y^{2}) - (- \frac{1}{3} - y^{2})] \ dy = \int^{1}_{0}(\frac{2}{3}+2y^{2}) \ dy = (\frac{2}{3}y + \frac{2}{3}y^{2}) º = ((\frac{2}{3}(1) + \frac{2}{3}(1)) - (\frac{2}{3}(0) - \frac{2}{3}(0))) = \frac{4}{3} $ \\
...
\[\begin{minipage}[b]{0.4\textwidth}
    \includegraphics[width=\linewidth]{assets/paraboloide_plano.png}
\end{minipage}\]
\subsection*{Integrales en Regiones Elementales}
\label{subsec:integrales_regiones_elementales}
\[\begin{minipage}[b]{1\textwidth}
    \includegraphics[width=\linewidth]{assets/region_elemental_tipo_1.png}
\end{minipage}\]
\[\begin{minipage}[b]{1\textwidth}
    \includegraphics[width=\linewidth]{assets/region_elemental_tipo_1_2.png}
\end{minipage}\]
\[\begin{minipage}[b]{1\textwidth}
    \includegraphics[width=\linewidth]{assets/region_elemental_tipo_2_1.png}
\end{minipage}\]
\[\begin{minipage}[b]{1\textwidth}
    \includegraphics[width=\linewidth]{assets/region_elemental_tipo_2_2.png}
\end{minipage}\]
\subsection*{Teorema de Cambio de Variable}
\label{subsec:cambio_variable}
1. Sea $D = \{(x,y) \in \float^{2}:x^{2} + y^{2} \le 1, y \ge 0\}$ calcule su área. \\
Lo primero que intentaríamos hacer es describirla como tipo I o tipo II, pero haciendola de tipo II nos quedaría $D = \{(x,y) \in \float^{2}: -1 \le x \le 1, 0 \le y \le \sqrt{1-x^{2}}\}$. Si intentás hacer la integral, te vas a dar cuenta que es dificil. \\
El teorema viene a salvarnos la vida, por qué? porque como estamos hablando de una circunferencia y una restricción de ella $y \ge 0$ podemos hacer un gráfico aproximado y ver a ojo, cual es su radio y cual es su ángulo (recorrido). \\
Sabemos por fórmula, que es una circunferencia de radio 1 y centro (0,0) pero ¿cómo cambia su ángulo?. Si $y \ge 0$ entonces la parte de la circunferencia que sobrevive es el primer y segundo cuadrante, y estos corresponden a $0 \le \theta \le \pi $ \\
\textbf{Importante}: Graficar. Por obvios motivos y porque este ejemplo es sencillo decidí omitirlo. \\
Una vez que conocemos esa información, listo. Ya podemos aplicar el teorema de cambio de variable porque sabemos que el Jacobiano cuando vamos a usar polares es siempre \textbf{r} por lo tanto no necesitamos decir nada más. Entonces, veamos como como cambió y ahora sí veamos qué representa nuestro cambio de variable. \\
$D = \{(x,y) \in \float^{2}: -1 \le x \le 1, 0 \le y \le \sqrt{1-x^{2}}\}$ pasamos a $D^{*} = \{(r, \theta) \in \float^{2}: 0 \le r \le 1, 0 \le \theta \le \pi \}$ \\
Grafiquemos $D^{*}$
\[\begin{minipage}[b]{0.9\textwidth}
    \includegraphics[width=\linewidth]{assets/tcv.jpg}
\end{minipage}\]
Como podemos notar, ahora nuestra región en coordenadas polares es un rectángulo y podemos integrar en cualquier orden (se recomienda primero las constantes), por lo tanto lo único que resta hacer es: $\int \int_{D} 1 \ dx \ dy \stackrel{T(D^{*}) = D}{=} \int \int_{D^{*}} 1 \ r dr d \theta = \int^{\pi}_{0} (\int^{1}_{0} \ r \ dr \ d\theta)$ que termina dando $\frac{\pi}{2}$. \\
2. Sea $D = \{(x,y) \in \float^{2}: y > 0, 1 \le x^{2} + y^{2} \le 4\}$, calcular $\int \int_{D} = \sqrt{4-x^{2}-y^{2}}$ \\
Mismo caso que el anterior. Como nuestro D es una circunferencia de radio 2 (que empieza a partir del 1 hacia arriba) el dibujo es ligeramente diferente. \\
\[\begin{minipage}[b]{0.9\textwidth}
    \includegraphics[width=\linewidth]{assets/tcv2.jpg}
\end{minipage}\]
Bueno, misma idea que antes. Como estamos usando polares, sabemos que el Jacobiano va a ser \textbf{r}. \\
Por lo tanto, nuestro $D^{*} = \{(r, \theta) \in \float^{2}: 1 \le r \le 2, 0 \le \theta \le \pi \}$, y sabemos que satisface que $T(D^{*}) = D$ por el teorema de cambio de variable. \\
Luego, $\int \int_{D} \sqrt{4 - x^{2} - y^{2}} dx \ dy \stackrel{TCV}{=} \int \int_{D^{*}} \sqrt{4-r^{2} * r} \ dr \ d\theta$. Queda resolver la integral y listo. \\
3. Hallar el área de $D = \{(x,y) \in \float^{2} / 1 \le x^{2} + y^{2} \le 9, 0 \le x \le y\}$ \\
Primera idea: Nótese que el círculo que vamos a dibujar empieza desde radio 1 hacia arriba, particularmente hasta radio 3. Luego, vemos que x es \textbf{a lo sumo y}. Por lo tanto, si queremos ver cual es el máximo valor que toma x podemos hacer $ x = y$, y reemplazar en la ecuación de la circunferencia. \\
Esto nos dará $ x^{2} + x^{2} = 9 \iff x = \pm 2.1$ aprox, entonces sabemos que el área que hay que pintar no tiene que ser mayor a 2.1 en x. \\
Luego, por también $x\le y$ sabemos que si vemos la igualdad $x = y$ esto es una recta que pasa por el origen. \\
Juntando todos estos datos, nos quedaría algo así:
\[\begin{minipage}[b]{0.9\textwidth}
    \includegraphics[width=\linewidth]{assets/tcv3.jpg}
\end{minipage}\]
Nótese que si el dibujo está totalmente bien, a ojo podemos notar que la parte coloreada es básicamente la región $\frac{\pi}{2} \ a \ \frac{\pi}{4}$. Lo único que nos queda ver es el radio, pero sabemos que es $1 \le r \le 3$ y como son polares, el Jacobiano lo conocemos y es r. \\
La integral entonces nos quedaría $\int \int_{D} = 1 dA \stackrel{TCV}{=} \int^{\frac{\pi}{4}}_{\frac{\pi}{2}} \int^{3} \int^{1} 1 \ r \ dr \ d \theta$ = $\pi$ \\
\textbf{Importante}: Si se diese el caso que por ejemplo, nuestro gráfico incluye el 1er y 3er cuadrante, se representaría con un ángulo negado. Ese ángulo negado, en realidad es $\frac{3}{2}pi$ pero acá ese rango lo vamos a tomar como $-\frac{\pi}{2}$ a $\frac{\pi}{2}$ \\
\textbf{Importante 2}: Recordar también, que si se da el caso de que nos dan una circunferencia para completar cuadrados o ya lista, y el centro NO es el (0,0) podemos justificar con que vale igual pasarlo a polares de la misma forma como si estuviese centrada en el (0,0) porque al ser una constante (lo que nos mueve del origen), al momento de calcular las derivadas para el Jacobiano no nos aportan en nada. \\
\textbf{Importante 3}: Si no se nos ocurre qué angulo que tiene una recta, por ejemplo y = x. Podemos hallar la pendiente de esa recta, y calcular $m=1, \ tg(\theta) = 1 \rightarrow \theta = \frac{\pi}{4}$
4. Ahora sí, veamos un ejemplo que tengamos que calcular el Jacobiano a mano. \\
Calcular $\int \int_{R} cos(\frac{y-x}{y+x}) dA$ donde R es la región trapezoidal con vértices (1,0), (2,0), (0,2) y (0, 1). \\
Bueno, acá no podemos usar polares porque la región R que nos dan no es una circunferencia. \\
Si hacemos el gráfico, veremos que nos queda una figura bastante complicada de hacer de tipo I o tipo II. 
\[\begin{minipage}[b]{0.9\textwidth}
    \includegraphics[width=\linewidth]{assets/tcv4.jpg}
\end{minipage}\]
Entonces ahora sí, tenemos que encontrar a mano todo. \\
Como no tenemos muchos datos, lo que hacemos es tomar los argumentos del coseno (que es lo que vamos a tener que integrar, y es dificil), y lo convertimos en u y al otro en v. \\
Entonces recordando la definición tiene que suceder que $T(D^{*}) = D$. \\
Armamos $u(x,y) = -x+y$, $v(x,y) = x+y$ y ahora conseguimos armar una transformación, que nos da $\hat{T} (x,y) = (-x+y, x+y)$ y evaluando los puntos de nuestro figura nos quedan los siguientes puntos 
\begin{itemize}
    \item $\hat{T}(0, 1) = (1, 1)$
    \item $\hat{T}(1,0) = (-1, 1)$
    \item $\hat{T}(2, 0) = (-2, 2)$
    \item $\hat{T}(0, 2) = (2, 2)$
\end{itemize}
Entonces ahora, ya conseguimos nuestro gráfico. Veamos qué se forma y de qué manera lo podemos expresar. 
\[\begin{minipage}[b]{0.6\textwidth}
    \includegraphics[width=\linewidth]{assets/tcv5.jpg}
\end{minipage}\]
Esta nos conviene hacerla de tipo II porque el piso y el techo van a ser dos simples rectas. \\
Entonces nos queda $-v \le u \le v$ y $ 1 \le v \le 2$. Esto que conseguimos nos sirve para los límites de la integral. \\
Ahora para hallar T(u, v), necesitamos el jacobiano. \\
Teniendo $u = -x + y, \ v = x + y $, y despejando el sistema de ecuaciones lineales nos queda $T(u,v) = (- \frac{u}{2} + \frac{v}{2}, \frac{u}{2} + \frac{v}{2})$, armamos la matriz derivando coordenada a coordenada con respecto a u, y luego a v y nos queda que $\longitud{det(DT)} = \frac{1}{2}$. \\
Finalmente, luego de todo este proceso nos queda resolver la integral: $\int^{2}_{1} \int^{v}_{-v} cos(\frac{u}{v}) \frac{1}{2} \ du \ dv $
\subsection*{Coordenadas Cilíndricas}
\label{subsec:coordenadas_cilindricas}
\textbf{Ejercicio 1.}: Calcular el volumen de $E = \{(x,y,z) \in \float^{3}: y \ge 0, 1 \le x^{2} + y^{2} \le 9, 0 \le z \le x^{2} + y^{2}\}$ \\
La buena pregunta antes de comenzar todo ejercicio es: ¿por qué usar cilíndricas? \\
En este caso la respuesta está en que las dos superficies que nos están dando son de la pinta $x^{2} + y^{2}$ en $\float^{3}$. Es decir, cilindros. \\
Una vez que ya detectamos que este ejercicio sale por coordenadas cilíndricas, recordemos qué es lo que necesitamos en la transformación a cilíndricas. 
\begin{itemize}
    \item r: Será el radio donde se moverá el volumen/área que querramos integrar.
    \item $\theta$: Será el ángulo determinado por $x, y$ el cual se moverá el volumen en el piso. 
    \item $z$: z prácticamente igual pero escrito en coordenadas polares.
\end{itemize}
Recordemos que por coordenadas polares, sabemos que $r^{2} = x^{2} + y^{2}$ y además que, en este caso el Jacobiano es r. \\
Una vez que tenemos toda esta información ya podemos comenzar a pensar cómo va a quedar la integral. \\
Lo primero es lo primero, el radio no puede ser cualquiera, sino que el radio va a ser básicamente entre todas las figuras, el espacio que tengan todas en común. Por lo tanto, lo primero que podemos hacer es analizar cada superficie una por una. \\
Analicemos $1 \le x^{2} + y^{2} \le 9$: Esto es un cilindro hueco, que empieza a contar desde \textbf{radio 1 hasta radio 3} ($ 1 \le r^{2} \le 9 \equiv 1 \le r \le 3$). Notar que NO aparece z. Por lo tanto no aporta NADA en z. \\
Analicemos $0 \le z \le x^{2} + y^{2}$: Si nos ponemos a ver curvas de nivel esto es un paraboloide que se compone por dos cosas: en $z = 0$ hay un plano, y a partir de $z=0$ está el paraboloide. \\
Si juntamos ambas superficies en un gráfico, como el cilindro tiene un ancho determinado y el paraboloide no, entonces de alguna manera sabemos que el paraboloide atravesará al cilindro en una altura dada. \\
\textbf{Radio}: Pensemos ahora qué podemos decir del radio. Como el paraboloide no aporta información de radios particulares (porque son infinitos), en este caso nos quedamos con el subconjunto más chico que sabemos que está incluído en el paraboloide. En este caso, decimos que el radio es: $1 \le r \le 3$. ¿Por qué? Porque este radio que está en el cilindro (una superficie mucho más chica que un paraboloide en ancho). \\
\textbf{$\theta$}: La única condición que tenemos acerca del piso, es que $y \ge 0$. Por lo tanto, la única forma de que esto se cumpla, es que valga $0 \le \theta \le \pi$. \\
\textbf{Techo / Piso}: Como el Cilindro no aporta información sobre techo y piso de la región que tenemos que contemplar porque en z es infinito, sabemos que el piso del volumen que tenemos que contemplar es el plano $z=0$ y el techo es el mismo paraboloide $x^{2} + y^{2}$ que en polares es r. \\
Por lo tanto, la Integral a resolver queda: $ \int^{3}_{1} \int^{\pi}_{0} \int_{0}^{r^{2}} 1 * r * dz \ d\theta \ dr$

\subsection*{Funciones Trigonométricas}
\begin{itemize}
    \item sen, cos: acotadas entre [-1, 1]
    \item arctan, arcsen: acotada entre $[-\frac{\pi}{2}, \frac{\pi}{2}]$
    \item arccos: acotada entre $[0, \pi]$
\end{itemize}
\subsection*{Más Integrales}
\begin{itemize}
    \item $\int e^{-y} = -e^{-y}$ Sale por sustitución con u = -y, du = -1 dx. 
    \item $\int e^{-ln(x)} = \frac{1}{x}$
\end{itemize}
\end{document} 
