...
1. Sea $f(x) = \sqrt{1+x}$, calcule el Polinomio de Maclaurin de orden 2, halle la expresión del resto y estime el error que se comete al aproximar f(0,2) por p(0,2) \\
