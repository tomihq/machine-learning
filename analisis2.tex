...
\textbf{Importante}: Sea el orden en que integremos, dan exactamente igual. Es decir, da igual integrar primero x y luego y, que primero y y después x. Quizá la expresión no queda exactamente igual pero el \textbf{resultado} debe ser exactamente lo mismo.
\[\begin{minipage}[b]{0.8\textwidth}
