...
Nos sirve para pasar por un punto dado con alguna recta que tenga dirección.
...
\begin{itemize}
    ...
    \item $\forall v \in \float^{2} \ \exists \ \frac{\partial f}{\partial v}(x,y) = <\triangledown f (x_{0}, y_{0}), \frac{v}{\longitud{\longitud{v}}}>$
\end{itemize} 
...
\[f(x_{0}, y_{0}) + f_{x}(x_{0}, y_{0})(x-x_{0})+f_{y}(x-x_{0})(y-y_{0})\] 
\textbf{Completar bien}
\section*{Anexo}
\subsection*{Esferas}
