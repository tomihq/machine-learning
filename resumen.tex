...
\end{cases}
\]
\textbf{Nota}: Una recta es una especie de Curva. \\
Definimos la Curva Paramétrica C como $ C=\{(x(t), y(t)) / t \in I\}$. Le decimos paramétrica porque espera un parámetro. \\
\textbf{Importante}: (x(t), y(t)) es conocido como la parametrización de la curva. Existen infinitas parametrizaciones para una curva.
\subsection*{Trayectoria de la partícula}
Toda curva tiene una trayectoria dada. La ídea es que la partícula se va moviendo a lo largo del tiempo. Es útil e importante, ver como progresa la curva a lo largo del tiempo e indicar hacía donde se dirige la partícula en cada momento.
\section*{Anexo}
\subsection*{Esferas}
