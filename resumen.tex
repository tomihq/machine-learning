...
\subsection*{Diferenciabilidad en Curva dada por forma vectorial}
...
\section*{Derivada parcial de una función definida implícitamente}
Sea f $Z=Z(x,y)$
...
Si $f:D \subseteq \float^{2} \rightarrow \float$ y existen $f_{xy}, \ f_{yx}$ y son continuas en D. Entonces $f_{xy}=(x_{0}, y_{0}) = f_{yx}(x_{0}, y_{0})$ para todo $(x_{0}, y_{0}) \in D$ \\
